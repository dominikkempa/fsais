...
void em_induce_plus_star_substrings_large_alphabet(
  ...
  typedef async_stream_writer<extext_block_id_type> output_pos_writer_type;
...
void em_induce_plus_star_substrings(
  ...
  if (text_alphabet_size <= 2000000)
    em_induce_plus_star_substrings_small_alphabet<char_type, text_offset_type, extext_block_id_type>(text_length,
    ...
    em_induce_plus_star_substrings_large_alphabet<char_type, text_offset_type, extext_block_id_type>(text_length,
