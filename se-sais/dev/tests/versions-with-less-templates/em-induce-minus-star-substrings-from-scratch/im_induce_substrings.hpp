...
bool im_induce_substrings_small_alphabet(
  ...
  typedef async_stream_writer<ext_block_offset_type> output_minus_pos_writer_type;
...
void im_induce_substrings(
  ...
  if (text_alphabet_size <= 2000000) {
    im_induce_substrings_small_alphabet<char_type, text_offset_type, ext_block_offset_type>(text_alphabet_size, text_length,
