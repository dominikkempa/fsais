...
std::uint64_t em_induce_plus_suffixes(
  ...
  minus_pos_reader_type *minus_pos_reader = new minus_pos_reader_type(minus_pos_filename, 4UL * computed_buf_size, 4UL);
  ...
  output_pos_writer_type *output_pos_writer = new output_pos_writer_type(output_pos_filename, (1UL << 20)/*XXX*/, 4UL * computed_buf_size, 4UL);
