...
void test(std::uint64_t, std::uint64_t, std::uint64_t, std::uint64_t, std::uint64_t, std::uint64_t) {}
...
void test<std::uint8_t>(std::uint64_t radix_log, std::uint64_t testcases, std::uint64_t max_operations, std::uint64_t max_key,
  ...
  fprintf(stderr, "TEST, key_type=std::uint8_t, em_ram_queues=%lu, bufsize=%lu, radix_log=%lu, testcases=%lu, max_operations=%lu, max_key=%lu\n",
      em_ram_queues, bufsize, radix_log, testcases, max_operations, max_key);
...
//    fprintf(stderr, "\n\nNEWTEST:\n");
    ...
    heap_type *heap = new heap_type(radix_log, "./tmp", em_ram_queues, bufsize);
...
void test<std::uint16_t>(std::uint64_t radix_log, std::uint64_t testcases, std::uint64_t max_operations, std::uint64_t max_key,
    std::uint64_t bufsize, std::uint64_t em_ram_queues) {
  fprintf(stderr, "TEST, key_type=std::uint16_t, em_ram_queues=%lu, bufsize=%lu, radix_log=%lu, testcases=%lu, max_operations=%lu, max_key=%lu\n",
      em_ram_queues, bufsize, radix_log, testcases, max_operations, max_key);
...
void test<std::uint32_t>(std::uint64_t radix_log, std::uint64_t testcases, std::uint64_t max_operations, std::uint64_t max_key,
    std::uint64_t bufsize, std::uint64_t em_ram_queues) {
  fprintf(stderr, "TEST, key_type=std::uint32_t, em_ram_queues=%lu, bufsize=%lu, radix_log=%lu, testcases=%lu, max_operations=%lu, max_key=%lu\n",
      em_ram_queues, bufsize, radix_log, testcases, max_operations, max_key);
...
void test<uint40>(std::uint64_t radix_log, std::uint64_t testcases, std::uint64_t max_operations, std::uint64_t max_key,
    std::uint64_t bufsize, std::uint64_t em_ram_queues) {
  fprintf(stderr, "TEST, key_type=uint40, em_ram_queues=%lu, bufsize=%lu, radix_log=%lu, testcases=%lu, max_operations=%lu, max_key=%lu\n",
      em_ram_queues, bufsize, radix_log, testcases, max_operations, max_key);
...
void test<uint48>(std::uint64_t radix_log, std::uint64_t testcases, std::uint64_t max_operations, std::uint64_t max_key,
    std::uint64_t bufsize, std::uint64_t em_ram_queues) {
  fprintf(stderr, "TEST, key_type=uint48, em_ram_queues=%lu, bufsize=%lu, radix_log=%lu, testcases=%lu, max_operations=%lu, max_key=%lu\n",
      em_ram_queues, bufsize, radix_log, testcases, max_operations, max_key);
...
void test<std::uint64_t>(std::uint64_t radix_log, std::uint64_t testcases, std::uint64_t max_operations, std::uint64_t max_key,
    std::uint64_t bufsize, std::uint64_t em_ram_queues) {
  fprintf(stderr, "TEST, key_type=std::uint64_t, em_ram_queues=%lu, bufsize=%lu, radix_log=%lu, testcases=%lu, max_operations=%lu, max_key=%lu\n",
      em_ram_queues, bufsize, radix_log, testcases, max_operations, max_key);
...
int main() {
  ...
  for (std::uint64_t bufsize = /*1*/3; bufsize <= /*(1UL << 13)*/16; bufsize = std::max(bufsize + 1, bufsize * 2))
    for (std::uint64_t radix_log = 1; radix_log <= 5; ++radix_log)
      run_tests_with_given_radix_log(radix_log, bufsize, /*500*/0);
