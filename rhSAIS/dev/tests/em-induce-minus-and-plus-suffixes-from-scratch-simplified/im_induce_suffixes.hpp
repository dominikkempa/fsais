...
im_induce_suffixes_small_alphabet(
  ...
  ext_text_offset_type *bucket_ptr = new ext_text_offset_type[text_alphabet_size];
  std::fill(bucket_ptr, bucket_ptr + text_alphabet_size, (ext_text_offset_type)0);
  ...
  // Allocate buckets.
  ext_text_offset_type *buckets = new ext_text_offset_type[total_bucket_size];
  std::fill(buckets, buckets + total_bucket_size, (ext_text_offset_type)0);
...
void im_induce_suffixes_small_alphabet(
  ...
  if (max_block_size < (1UL << 31))
    im_induce_suffixes_small_alphabet<char_type, text_offset_type, std::uint32_t>(text_alphabet_size, text_length,
    ...
    im_induce_suffixes_small_alphabet<char_type, text_offset_type, uint40>(text_alphabet_size, text_length,
        max_block_size, next_block_leftmost_minus_star_plus_rank, text_filename, minus_pos_filenames, output_plus_pos_filenames,
        output_plus_symbols_filenames, output_plus_type_filenames, output_minus_pos_filenames, output_minus_type_filenames,
        output_minus_symbols_filenames, minus_block_count_targets, total_io_volume);
  else
    im_induce_suffixes_small_alphabet<char_type, text_offset_type, std::uint64_t>(text_alphabet_size, text_length,
        max_block_size, next_block_leftmost_minus_star_plus_rank, text_filename, minus_pos_filenames, output_plus_pos_filenames,
        output_plus_symbols_filenames, output_plus_type_filenames, output_minus_pos_filenames, output_minus_type_filenames,
        output_minus_symbols_filenames, minus_block_count_targets, total_io_volume);
}
